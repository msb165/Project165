...
namespace Project165.Common.Systems.World
{
    public class SlimeArena : MicroBiome
    {
        ...
        {     
            ...
            WorldUtils.Gen(new Point(origin.X + 40, origin.Y + 39), new Shapes.Rectangle(4, 1), Actions.Chain(new Modifiers.SkipTiles(TileID.LihzahrdBrick), new Actions.SetTile(TileID.Chlorophyte).Output(entraceShape), new Modifiers.Expand(1)));
            ...
            WorldGen.PlaceTile(altarPos.X + 30, altarPos.Y, ModContent.TileType<SlimeAltar>());
