    ...
    public class ShadowBladeProj : ModProjectile
    {
        ...
        {            
            ...
            if (AITimer % 5f == 0f && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Player.Center + new Vector2(Projectile.velocity.X, -250f), new(speedX, 2f), ModContent.ProjectileType<ShadowSlash>(), (int)(Projectile.damage * 1.125f), Projectile.knockBack * 2f, Projectile.owner, 0f, 1f);
            }
