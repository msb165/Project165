...
public class SuperFireSwordHoldoutProj : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            Dust dust = Dust.NewDustPerfect(Vector2.Lerp(Projectile.Center, Projectile.Center + 44f * Projectile.rotation.ToRotationVector2() * Projectile.scale, Main.rand.NextFloat(0.1f, 1f)), DustID.OrangeTorch, Scale:2f);
            dust.noGravity = true;
        }
    }
